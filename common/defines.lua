...
country = {
	YEARS_OF_NATIONALISM 	= 5,   -- Years of Nationalism
	MONTHS_UNTIL_BROKEN 		= 6,    -- OBSOLETE! (Months until rebel held capital results in broken country.)
	...
	CAMPAIGN_EVENT_BASE_TIME = 84, -- once every 6 weeks.
	CAMPAIGN_EVENT_MIN_TIME = 24 ,-- never more often than 3 weeks between
	CAMPAIGN_EVENT_STATE_SCALE = -3,	-- every non-colonial state reduces by 3 days.
	CAMPAIGN_DURATION = 3,	-- a campaign lasts these amount of months
	...
	BASE_MONTHLY_DIPLOPOINTS = 2.0, -- Base value gain for diplomatic actions each month
	...
	MOVEMENT_RADICALISM_PASSED_REFORM_EFFECT  = -5,
	...
	INVESTMENT_SCORE_FACTOR = 0.002, -- how much foreign investment money counts towards your industry score
	UNCIV_TECH_SPREAD_MAX = 0.60,
	UNCIV_TECH_SPREAD_MIN = 0.15,
	MIN_DELAY_BETWEEN_REFORMS = 5, -- months
	...
	NAVAL_BASE_SUPPLY_SCORE_BASE = 15, -- base value that is powered by level of naval base. Determines the naval supplying capabilities.
...
military = {
	...
	LEADER_TRANSFER_PENALTY_ON_COUNTRY_PRESTIGE = 0.08, -- country prestige penalty on unassign leader (f.ex if leader has 100% prestige, the country loose 4% of its prestige)
...
ai =
{
	...
	ADMINISTRATOR_WEIGHT = 8.0, -- ai weight for new bureaucrat
